...
func (m *V1Policy) validatePermissions(formats strfmt.Registry) error {
...
func (m *V1Policy) contextValidatePermissions(ctx context.Context, formats strfmt.Registry) error {
