...
func (m *FunctionsGetFunctionsResponse) validateFunctions(formats strfmt.Registry) error {
...
func (m *FunctionsGetFunctionsResponse) contextValidateFunctions(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FunctionsGetFunctionsResponse) UnmarshalBinary(b []byte) error {
	var res FunctionsGetFunctionsResponse
