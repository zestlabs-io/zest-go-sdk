...
func (m *V1UpdatePolicyRequest) validatePolicy(formats strfmt.Registry) error {
...
func (m *V1UpdatePolicyRequest) contextValidatePolicy(ctx context.Context, formats strfmt.Registry) error {
