...
func (m *DistrconfigGetUserResponse) validateUser(formats strfmt.Registry) error {
...
func (m *DistrconfigGetUserResponse) contextValidateUser(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DistrconfigGetUserResponse) UnmarshalBinary(b []byte) error {
	var res DistrconfigGetUserResponse
