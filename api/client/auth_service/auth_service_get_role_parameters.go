...
// NewAuthServiceGetRoleParams creates a new AuthServiceGetRoleParams object
// with the default values initialized.
func NewAuthServiceGetRoleParams() *AuthServiceGetRoleParams {
	var ()
	return &AuthServiceGetRoleParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewAuthServiceGetRoleParamsWithTimeout creates a new AuthServiceGetRoleParams object
...
// NewAuthServiceGetRoleParamsWithContext creates a new AuthServiceGetRoleParams object
...
// NewAuthServiceGetRoleParamsWithHTTPClient creates a new AuthServiceGetRoleParams object
...
for the auth service get role operation typically these are written to a http.Request
*/
...
func (o *AuthServiceGetRoleParams) WithTimeout(timeout time.Duration) *AuthServiceGetRoleParams {
...
func (o *AuthServiceGetRoleParams) WithContext(ctx context.Context) *AuthServiceGetRoleParams {
	o.SetContext(ctx)
	return o
}
...
func (o *AuthServiceGetRoleParams) WithRoleID(roleID string) *AuthServiceGetRoleParams {
	o.SetRoleID(roleID)
	return o
}
...
func (o *AuthServiceGetRoleParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
